      ...
      <div>
        ...
        <Dialog open={mobileFiltersOpen} onClose={setMobileFiltersOpen} className="relative z-40 lg:hidden">
          ...
          <div className="fixed inset-0 z-40 flex">
            <DialogPanel
              transition
              className="relative ml-auto flex size-full max-w-xs flex-col overflow-auto bg-white py-4 shadow-xl z-50"
            >
              <div className="flex flex-col h-full">
                ...
                <div className="mt-auto flex items-center justify-between px-4">
                  <button
                    ...
                    className="-mr-2 flex size-10 items-center justify-center rounded-md bg-white p-2 text-gray-400 z-50"
                  >
